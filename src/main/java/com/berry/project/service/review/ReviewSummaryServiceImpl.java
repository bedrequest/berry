        ...
        List<ReviewChatMessageDTO> messages = List.of(
                new ReviewChatMessageDTO(
                        ...
                        "당신은 숙소 리뷰 전문가입니다. 이 숙소의 가장 매력적인 3가지 장점과 추천포인트를 뽑아, " +
                                ...
                                "각 문장 끝에 `<br/>` 태그를 붙여 주세요. **3~4문장**, **약 100~140단어** 분량의 한 단락으로 절대 초과하지 말고, 자연스럽게 작성해 문장을 마무리해주세요."
                ),
                new ReviewChatMessageDTO(
                        "user",
                        "아래 리뷰들을 참고해, 이 숙소의 핵심 장점과 추천 포인트를 요약해 주세요.\n\"\"\"\n" +
                                combined +
                                "\n\"\"\"\n" +
                                "각 문장 끝에 `<br/>` 태그를 넣고, 3~4문장, 약 100~140단어 분량의 한 단락으로 절대 초과하지 말고 작성해 문장을 마무리해주세요."
                )
