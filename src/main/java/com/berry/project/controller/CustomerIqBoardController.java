...
public class CustomerIqBoardController {
    ...
    // 게시글 등록
    @PostMapping
    public ResponseEntity<CustomerIqBoardDTO> create(@RequestBody CustomerIqBoardDTO request) {
        CustomerIqBoardDTO response = service.create(request);
        return ResponseEntity.ok(response);
    }

//    // 게시글 목록 조회
//    @GetMapping
//    public ResponseEntity<List<CustomerIqBoardDTO>> list() {
//        CustomerIqBoardDTO responses = service.list();
//        return ResponseEntity.ok(responses);
//    }
//
//    // 게시글 상세 조회
//    @GetMapping("/{bno}")
//    public ResponseEntity<CustomerIqBoardDTO> detail(@PathVariable Long bno) {
//        CustomerIqBoardDTO.response = service.detail(bno);
//        return ResponseEntity.ok(response);
//    }
//
//    // 게시글 수정
